...
l = Livre("", 0, "", 100, Genre.FANTASTIQUE )
l2 = Livre("", 0, "", 100, Genre.FANTASTIQUE )
l3 = Livre.new("titre", "auteur", Genre.ROMAN)

l3.afficher_infos()

print(Livre.afficher_nb_document())
print(Livre.compteur_pages([l, l2]))
